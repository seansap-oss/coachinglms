...
export const DEFAULT_CATEGORIES: UniqloCategory[] = [
  ...
  { id:'cat_dresses', slug:'dresses', name:'Dresses', gender:'WOMEN', image:'https://images.unsplash.com/photo-1515372039744-f1fd71e2d979?w=600', sortOrder:4, isActive:true },
...
export const DEFAULT_PRODUCTS: UniqloProduct[] = [
  ...
  mk({ id:'p009', name:'Linen Blend Long Dress', description:'Breezy linen blend perfect for spring.', categoryId:'cat_dresses', gender:'WOMEN', price:39.90, images:['https://images.unsplash.com/photo-1515372039744-f1fd71e2d979?w=800'], colors:[{name:'White',hex:'#fff'},{name:'Blue',hex:'#6ea8c7'}], sizes:['XS','S','M','L'], inStock:true, available:true, isFeatured:true, rating:4.7, reviewCount:274 }),
  ...
  mk({ id:'p012', name:'Baby Cotton Bodysuit 3 Pack', description:'Soft organic cotton with snap buttons.', categoryId:'cat_tops', gender:'BABY', price:14.90, images:['https://images.unsplash.com/photo-1522771930-78848d9293e4?w=800'], colors:[{name:'White',hex:'#fff'},{name:'Beige',hex:'#d9c7b8'}], sizes:['60','70','80','90'], inStock:true, available:true, rating:4.9, reviewCount:76 }),
...
export const DEFAULT_SECTION_IMAGES: UniqloSectionImage[] = [
  ...
  { id:'s4', title:'Shop Baby', image:'https://images.unsplash.com/photo-1522771930-78848d9293e4?w=800', link:'/collection/baby', sortOrder:4, isActive:true },
];
